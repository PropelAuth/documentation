...
### Alerting on Impersonation Sessions

You can choose to be proactively notified when a user impersonation session is started. Alerting can occur via webhook, email or Slack. 
