---
title: "Setting a Maximum Number of Users"

---

When creating a pricing structure for your product, it's common to limit a number of users in an organization depending 
...
When a customer signs up for your product and selects a plan, you will want to assign the team to their own organization with 
the appropriate user limit depending on the plan they are paying for.
...
```js
updateOrgWithNewPricingInfo(plan, orgId) {
	if (plan === "hobby") {
