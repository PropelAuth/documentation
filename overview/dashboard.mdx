...
Additionally, under the User Insights tab, you can view two reports: Churned Users and Reengaged Users.
...
Churned Users displays the users that have not been active in the last 7, 14, or 30 days, meaning that they have not had a token refreshed in those periods.

![churned users insights tab](/images/churned-users.png)

Reengaged Users displays the users that have had a token refreshed in the last week or month, having been previously considered inactive in that selected period. 

![reengaged users insights tab](/images/reengaged-users.png)
