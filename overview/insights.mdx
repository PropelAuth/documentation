...
month-over-month measurements of user signups, active users, and active organizations.
...
Our re-engagement reports let you see if those efforts are successful! The Reengaged Users report displays the users who have used your product in the last week or month and 
were previously inactive in that selected period. The Reengaged Organizations report displays the same information but for organizations where at least one user in that 
organization used your product.
