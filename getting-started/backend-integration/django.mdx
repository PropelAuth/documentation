...
[Django Rest Framework library](/reference/backend/django).
...
in
[IsUserAuthenticated](/getting-started/backend-integration/django/#is-user-authenticated),
[AllowAny](/getting-started/backend-integration/django/#allow-any), and
[IsUserInOrg](/getting-started/backend-integration/django/#is-user-in-org).
...
Note that this will still set `request.propelauth_user` if a valid access token
is provided.
...
[IsUserAuthenticated](/getting-started/backend-integration/django/#is-user-authenticated),
[AllowAny](/getting-started/backend-integration/django/#allow-any), or any
...
See [Django Rest Framework Library Reference](/reference/backend/django) for
