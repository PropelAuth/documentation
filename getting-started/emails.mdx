...
If you'd like to send emails from a different domain, let us know at 
support@propelauth.com and we can set you up.
...
Set up the CNAME and TXT records with your DNS provider. Instructions for how to 
do this will vary depending on where you purchased the domain from. If you need 
any help, please reach out to us at support@propelauth.com. It may take a few 
minutes for the DNS records to be set and verified.
...
to update the email configuration in Project Settings.
