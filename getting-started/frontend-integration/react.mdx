...
description:
  ...
  hosted authentication service into your React application."
---
...
2. **displayIfLoggedOut**: A React eleent to display if the current user is
   logged out. Defaults to [RedirectToLogin](/reference/frontend-apis/react#redirecttologin)
...
| [orgHelper](/reference/frontend-apis/react#orghelper)       | An object with useful functions for managing organizations                                     |
| [accessHelper](/reference/frontend-apis/react#accesshelper) | An object with useful functions for accessing role and permissions (RBAC)                      |
...
| [accessToken](/overview/access-tokens)    | If user is logged in, this string can access your APIs on behalf of the user. Otherwise, null.                                |
| isLoggedIn                                             | Returns user logged in status                                                                                                 |
| [orgHelper](/reference/frontend/react#orghelper)       | An object with useful functions for managing organizations                                                                    |
| [accessHelper](/reference/frontend/react#accesshelper) | An object with useful functions for accessing role and permissions (RBAC)                                                     |
| [user](/reference/frontend/react#the-user-object)      | If user is logged in, this contains metadata about them. Otherwise, null                                                      |

## Other utilities

- [useLogoutFunction](/reference/frontend-apis/react#logout) - Returns a function for logging out the current user.

- [useRedirectFunctions](/reference/frontend-apis/react#useredirectfunctions) - Returns a set of functions to redirect the user to
  different pages (e.g. signup, login).

For a complete list of utilities, see the
[React Library Reference](/reference/frontend-apis/react). Alternatively, our guides
will walk you through the process of creating an entire application end to end.
