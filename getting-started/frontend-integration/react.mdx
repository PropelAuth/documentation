...
| [orgHelper](/reference/frontend-apis/react#orghelper)       | A class with useful functions for managing organizations                                     |
| [accessHelper](/reference/frontend-apis/react#accesshelper) | A class with useful functions for accessing role and permissions (RBAC)                      |
