...
| [orgHelper](/reference/frontend-apis/nextjs#org-helper)       | A class with useful functions for managing organizations                                     |
| [accessHelper](/reference/frontend-apis/nextjs#access-helper) | A class with useful functions for accessing role and permissions (RBAC)                      |
