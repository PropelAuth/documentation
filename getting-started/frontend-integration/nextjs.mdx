...
[here](/reference/frontend-apis/nextjs).
...
2. **displayIfLoggedOut**: A React eleent to display if the current user is
   logged out. Defaults to [RedirectToLogin](/reference/frontend-apis/nextjs#redirecttologin)
...
// A React Higher-Order Component that provides common values like isLoggedIn and accessToken. 
...
| [orgHelper](/reference/frontend-apis/nextjs#orghelper)       | An object with useful functions for managing organizations                                     |
| [accessHelper](/reference/frontend-apis/nextjs#accesshelper) | An object with useful functions for accessing role and permissions (RBAC)                      |
...
[Next.js Library Reference](/reference/frontend-apis/nextjs). Alternatively, our
