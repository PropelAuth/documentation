...
[AuthenticationInfo schema](/getting-started/frontend-integration/javascript) for
...
[getAuthenticationInfoOrNull](/reference/frontend/javascript/#get-current-user-information).
