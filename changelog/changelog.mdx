...
|--|----|
| **Feature** | Added [User Insights](/overview/insights), which includes churn and reengagement reports for users and organizations. |
...
| **Feature** | Post-login redirects have been added to the Google login flow. |
