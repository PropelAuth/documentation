...
|--|----|
| **Release** | We have released official support for applications built with NextJS 13, including both the App Router and the Pages Router For more information, checkout our [guide](/getting-started/nextjs)|
