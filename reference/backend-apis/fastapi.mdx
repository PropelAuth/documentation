...
[requireUser](/reference/backend-apis/fastapi/#requireuser),
[optionalUser](/reference/backend-apis/fastapi/#optional-user), or
[requireOrgMember](/reference/backend-apis/fastapi/#require-org-member).
...
Similar to [requireUser](/reference/backend-apis/fastapi/#require-user), except if an
...
1. Check that the user is a member of that organization. If not, the request is
