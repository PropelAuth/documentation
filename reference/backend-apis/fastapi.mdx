...
[requireUser](/reference/backend/fastapi/#requireuser),
[optionalUser](/reference/backend/fastapi/#optional-user), or
[requireOrgMember](/reference/backend/fastapi/#require-org-member).
...
Similar to [requireUser](/reference/backend/fastapi/#require-user), except if an
