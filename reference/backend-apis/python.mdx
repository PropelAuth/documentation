...
tokens in
[validate_access_token_and_get_user](/reference/backend/python/validate-access-token-and-get-user)
and
[validate_access_token_and_get_user_with_org](/reference/backend/python/validate-access-token-and-get-user-with-org).
