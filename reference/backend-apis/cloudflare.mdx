...
<ResponseField name="updateUserMetadataRequest" type="request object">
  <Expandable title="properties">
    ...
    <ResponseField query="properties" type="{ [key: string]: unknown }">
      A dictionary of custom properties for the user. See [Custom Properties](/overview/user-metadata) for more details.
    </ResponseField>
...
<ResponseField name="migrateUserFromExternalSourceRequest" type="request object">
  <Expandable title="properties">
    ...
    <ResponseField name="lastName" type="boolean">
      ...
      <ResponseField query="properties" type="{ [key: string]: any }">
          A dictionary of custom properties for the user. See [Custom Properties](/overview/user-metadata) for more details.
      </ResponseField>
...
<ResponseField name="createApiKeyRequest" type="request object">
  <Expandable>
    ...
    <ResponseField name="expiresInSeconds" type="number">
      How many seconds shloud the API key be valid for
    </ResponseField>
