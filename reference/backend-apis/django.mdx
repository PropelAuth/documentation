...
| impersonator_user_id | If someone on your team is impersonating another user, this will be set to the employee's ID. By default, user impersonation is turned off and this will be undefined |
...
Successful response is the same as [fetch_user_metadata_by_user_id](#fetch-user-metadata-by-user-id), expect it
