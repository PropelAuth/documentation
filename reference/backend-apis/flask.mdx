...
[require_user](/reference/backend/flask/#requireuser),
[optional_user](/reference/backend/flask/#optional-user), or
[require_org_member](/reference/backend/flask/#require-org-member).
...
Similar to [require_user](/reference/backend/flask/#require-user), except if an
