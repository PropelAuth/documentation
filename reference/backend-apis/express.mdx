...
[requireUser](/reference/backend-apis/express/#requireuser),
[optionalUser](/reference/backend-apis/express/#optional-user), or
[requireOrgMember](/reference/backend-apis/express/#require-org-member).
