...
tokens in
[validateAccessTokenAndGetUser](/reference/backend/node/#validate-access-token-and-get-user)
and
[validateAccessTokenAndGetUserWithOrgInfo](/reference/backend/node/#add-user-to-organization).
