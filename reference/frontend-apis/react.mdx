...
This is identical to [withAuthInfo](/reference/frontend-apis/react/#with-auth-info),
...
[useRedirectFunctions](/reference/frontend-apis/react/#use-redirect-functions).
