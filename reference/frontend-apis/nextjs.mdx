...
description:
  "This reference will cover how to use the @propelauth/react library with Next.js."
---
...
logged out. Defaults to [RedirectToLogin](#redirect-to-login)
...
[useRedirectFunctions](#use-redirect-functions) and also takes in the same
arguments as props.
