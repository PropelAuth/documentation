...
This document explains how to use PropelAuth with Client Side Rendering.
We are beta testing support for Server Side Rendering and the new App Router.
If you'd like to test that out, please email us at [support@propelauth.com](mailto:support@propelauth.com).